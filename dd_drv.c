   ...
   )
{
   ...
   DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_INFO_LEVEL,"[DDProxy] Loaded Config\n");
...
-- */
{
   ...
   DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_INFO_LEVEL,"[DDProxy] Added Filter for original flow\n");
   ...
   DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_INFO_LEVEL,"[DDProxy] Added Filter for proxy flow\n");
...
-- */
{
   ...
   DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_INFO_LEVEL, "[DDProxy] Registering datagram callouts\n");
   ...
   )
{
   ...
   DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_INFO_LEVEL, "[DDPROXY] Registered all callouts\n");
   ...
   DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_INFO_LEVEL,"[DDPROXY] Created system thread\n");
