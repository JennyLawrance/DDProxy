...
-- */
{
   ...
   DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_INFO_LEVEL, "[DDProxy] DDProxyClassify\n");
#if(NTDDI_VERSION >= NTDDI_WIN7)
   UNREFERENCED_PARAMETER(classifyContext);
#endif
   ...
   else
   {
      ...
      DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_INFO_LEVEL,"[DDProxy] Detected inbound packet\n");
   ...
   if (signalWorkerThread)
   {
      ...
      DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_INFO_LEVEL,"[DDProxy] Packet added to the list\n");
   }
   ...
   )
{
   ...
   DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_INFO_LEVEL, "[DDProxy] DDProxyFlowEstablishedNotify\n");
   ...
   )
{
   ...
   DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_INFO_LEVEL, "[DDProxy] DDProxyNotify\n");
...
-- */
{
   ...
   DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_INFO_LEVEL,"[DDProxy] Trying to re-inject outbound packet\n");
